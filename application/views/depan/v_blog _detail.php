...
<head>
  <meta charset="utf-8">
  <title>Detail Berita/artikel</title>
  ...
  <!-- Google Fonts -->
  <link href="<?php echo base_url(); ?>assets_frontend/blog/https://fonts.googleapis.com/css?family=Open+Sans:300,400,400i,600,700|Raleway:300,400,400i,500,500i,700,800,900" rel="stylesheet">

  <!-- Bootstrap CSS File -->
  <link href="<?php echo base_url(); ?>assets_frontend/blog/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">

  <!-- Libraries CSS Files -->
  <link href="<?php echo base_url(); ?>assets_frontend/blog/lib/nivo-slider/css/nivo-slider.css" rel="stylesheet">
...
<body data-spy="scroll" data-target="#navbar-example">
            ...
            <nav class="navbar navbar-default">
              ...
              <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll sticky-logo" href="<?php echo base_url(); ?>assets_frontend/blog/index.html">
                  <h1><span>Berita</span>& Artikel</h1>
          ...
          <div class="slider-content text-center">
            <div class="header-bottom">
              <div class="layer2 wow zoomIn" data-wow-duration="1s" data-wow-delay=".4s">
                <h1 class="title2">Berita & Artikel Detail </h1>
              </div>
              <div class="layer3 wow zoomInUp" data-wow-duration="2s" data-wow-delay="1s">
                <h2 class="title3">Rumah Tahfidz Ibnu Abbas Magetan</h2>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="page-head-blog">
              ...
              <div class="left-blog">
                ...
                <div class="recent-post">
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="<?php echo base_url(); ?>assets_frontend/blog/#">
                           <img src="<?php echo base_url(); ?>assets_frontend/blog/img/blog/1.jpg" alt="">
                        </a>
                    </div>
                    <div class="pst-content">
                      <p><a href="<?php echo base_url(); ?>assets_frontend/blog/#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
                    </div>
                  </div>
                  <!-- End single post -->
                  <!-- start single post -->
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="<?php echo base_url(); ?>assets_frontend/blog/#">
                           <img src="<?php echo base_url(); ?>assets_frontend/blog/img/blog/2.jpg" alt="">
                        </a>
                    </div>
                    <div class="pst-content">
                      <p><a href="<?php echo base_url(); ?>assets_frontend/blog/#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="<?php echo base_url(); ?>assets_frontend/blog/#">
                           <img src="<?php echo base_url(); ?>assets_frontend/blog/img/blog/3.jpg" alt="">
                        </a>
                    </div>
                    <div class="pst-content">
                      <p><a href="<?php echo base_url(); ?>assets_frontend/blog/#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
                  ...
                  <div class="recent-single-post">
                    <div class="post-img">
                      <a href="<?php echo base_url(); ?>assets_frontend/blog/#">
                           <img src="<?php echo base_url(); ?>assets_frontend/blog/img/blog/4.jpg" alt="">
                        </a>
                    </div>
                    <div class="pst-content">
                      <p><a href="<?php echo base_url(); ?>assets_frontend/blog/#"> Redug Lerse dolor sit amet consect adipis elit.</a></p>
            ...
            <div class="single-blog-page">
              <div class="left-blog">
                ...
                <ul>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Portfolio</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Project</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Design</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">wordpress</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Joomla</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Html</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Website</a>
                  </li>
                </ul>
              </div>
            </div>
            <div class="single-blog-page">
              <div class="left-blog">
                ...
                <ul>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">07 July 2016</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">29 June 2016</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">13 May 2016</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">20 March 2016</a>
                  </li>
                  <li>
                    <a href="<?php echo base_url(); ?>assets_frontend/blog/#">09 Fabruary 2016</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div class="left-tags blog-tags">
                <div class="popular-tag left-side-tags left-blog">
                  ...
                  <ul>
                    ...
                    <li>
                      <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Masonry</a>
                    </li>
                    <li>
                      <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Website</a>
                    </li>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <article class="blog-post-wrapper">
                <div class="post-thumbnail">
                  <img src="<?php echo base_url(); ?>assets_frontend/blog/img/blog/6.jpg" alt="" />
                </div>
                <div class="post-information">
                  <h2>Blog image post layout</h2>
                  <div class="entry-meta">
                    <span class="author-meta"><i class="fa fa-user"></i> <a href="<?php echo base_url(); ?>assets_frontend/blog/#">admin</a></span>
                    <span><i class="fa fa-clock-o"></i> march 28, 2016</span>
                    <span class="tag-meta">
                        <i class="fa fa-folder-o"></i>
                        <a href="<?php echo base_url(); ?>assets_frontend/blog/#">painting</a>,
                        <a href="<?php echo base_url(); ?>assets_frontend/blog/#">work</a>
                      </span>
                    <span>
                        <i class="fa fa-tags"></i>
                        <a href="<?php echo base_url(); ?>assets_frontend/blog/#">tools</a>,
                        <a href="<?php echo base_url(); ?>assets_frontend/blog/#"> Humer</a>,
                        <a href="<?php echo base_url(); ?>assets_frontend/blog/#">House</a>
                      </span>
                    <span><i class="fa fa-comments-o"></i> <a href="<?php echo base_url(); ?>assets_frontend/blog/#">6 comments</a></span>
                  </div>
                    ...
                    <ul>
                      <li class="threaded-comments">
                        <div class="comments-details">
                          <div class="comments-list-img">
                            <img src="<?php echo base_url(); ?>assets_frontend/blog/img/blog/b02.jpg" alt="post-author">
                          </div>
                          <div class="comments-content-wrap">
                            <span>
                                <b><a href="<?php echo base_url(); ?>assets_frontend/blog/#">demo</a></b>
                                Post author
                                <span class="post-time">October 6, 2014 at 4:25 pm</span>
                            <a href="<?php echo base_url(); ?>assets_frontend/blog/#">Reply</a>
                            </span>
                      ...
                      <li>
                        <div class="comments-details">
                          ...
                          <div class="comments-content-wrap">
                            <span>
                                <b><a href="<?php echo base_url(); ?>assets_frontend/blog/#">admin</a></b>
                                Post author
  ...
  <a href="<?php echo base_url(); ?>assets_frontend/blog/#" class="back-to-top"><i class="fa fa-chevron-up"></i></a>

  <!-- JavaScript Libraries -->
  <script src="<?php echo base_url(); ?>assets_frontend/blog/lib/jquery/jquery.min.js"></script>

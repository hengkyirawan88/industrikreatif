...
<body>
  ...
  <section id="hero" class="wow fadeIn">
    <div class="hero-container">
      <h1>Welcome to SIGIKREACAP</h1>
      <h2><b>Sistem Informasi Geografis Industri Kreatif Kabupaten Cilacap</b></h2>

      <div class="col-xs-6"> 
   <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Form Login Admin SIGIKREACAP</h3>
              </div>

              &nbsp; &nbsp; &nbsp;
              &nbsp; &nbsp; &nbsp;
              <form action="<?php echo base_url().'index.php/login_ikm_cilacap/aksi_login' ?>" method="post">
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal">
                ...
                <!-- /.card-body -->
               <button type="submit" class="btn-get-started scrollto"><b>LOGIN APLIKASI</b></button> 
                <!-- /.card-footer -->
              </form>

      <!-- <button type="submit" class="btn btn-info">Log in Admin</button> -->
      <span>Belum punya akun?<a href="http://industrikreatif.xyz/login_ikm_cilacap/registrasi"> Registrasi</a></span><br>
       </form>

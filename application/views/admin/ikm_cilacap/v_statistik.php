      ...
      <div class="col-lg-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Kelola Data Bahan baku</h3>
          </div>
...
<!--                                <td><?php echo $pp->tanggal; ?> </td> 
                               ...
                               <td>
                                <a href="<?php echo base_url().'admin/ikm_cilacap/statistik/edit/'.$pp->id_statistik; ?>" class="btn btn-warning btn-sm"> <i class="fa fa-pencil"></i> Edit</a>
                                 <a onclick="return konfirmasi()"href="<?php echo base_url().'admin/ikm_cilacap/statistik/delete/'.$pp->id_statistik; ?>" class="btn btn-danger btn-sm"> <i class="fa fa-trash"></i> Hapus</a>  
                              </td>
                            </tr>
                            <?php } ?> <!-- Selesai loop -->
                        </tbody>

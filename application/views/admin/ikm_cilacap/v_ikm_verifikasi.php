      ...
      <div class="col-lg-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title">Data Verifikasi Industri Kreatif</h3>
          </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                             ...
                             <!--   <td><?php echo substr($pp->isi ,0 ,250); ?> ..... dst... </td> -->
                               ...
                               <td>
                                <!-- <a href="<?php echo base_url().'admin/ikm_cilacap/ikm/detail/'.$pp->id_ikm; ?>" class="btn btn-success btn-sm"> <i class="fa fa-book"></i> Detail</a> -->

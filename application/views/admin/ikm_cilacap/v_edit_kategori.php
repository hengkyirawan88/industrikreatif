	...
	<section class="content">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<?php echo base_url('admin/ikm_cilacap/kategori') ; ?>" class="btn btn-sm btn-primary">Kembali</a>
				...
				<div class="box box-primary">
					<div class="box-header">
			            ...
			            <div class="box-body">
		                  ...
		                  <form class="form-horizontal" role="form" action="<?php echo base_url('admin/ikm_cilacap/kategori/update') ; ?>"enctype="multipart/form-data" method="post">
            ...
            <div class="box-body">
                ...
                <div class="col-lg-6">
                  ...
                  <input  type="text=" name="nama" class="form-control" style="width: 40%;" value="<?php echo $varkategori->nama;?> "> </input>
                </div>
...
<div class="col-lg-6">
                 ...
                 <!-- /.box-body -->
			        ...
			        <input type="hidden" class="form-control" id="inputSuccess" name="id" value="<?php echo $varkategori->id ;?>">         
			        </div>

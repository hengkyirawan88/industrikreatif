	...
	<section class="content">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<a href="<?php echo base_url('admin/ikn_cilacap/donatur') ; ?>" class="btn btn-sm btn-primary">Kembali</a>
				...
				<div class="box box-primary">
					<div class="box-header">
			            ...
			            <div class="box-body">
		                  ...
		                  <form class="form-horizontal" role="form" action="<?php echo base_url('admin/ikm_cilacap/donatur/tambah_donatur') ; ?>"enctype="multipart/form-data" method="post">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input  type="text" name="nama_bahanbaku" class="form-control" placeholder="Isikan nama bahan baku...."/>
                </div>
